...
def search_active_reservation_numbers(token, property_id, start_dt, end_dt, state="Active"):
    """
    PMS API: GET /v2/properties/{propertyId}/reservations/search
    Возвращает номера броней в статусе `state` ("Active" или "Cancelled"),
    затрагивающих период [start_dt, end_dt].
    """
